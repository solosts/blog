;(function () {
  var h = {},
    mt = {},
    c = {
      id: "732e5d11e524d6b4176fd0757fb60a08",
      dm: ["tjcblog.com"],
  ...
  ;(function () {
    ...
    mt.g.na = function (a) {
      ...
      try {
        ...
        for (
          var e = a.split(">"), b = document.body, n = e.length - 1;
          0 <= n;
          n--
        )
          if (-1 < e[n].indexOf("#")) {
            ...
            ;(b = document.getElementById(f)) ||
              (b = document.getElementById(decodeURIComponent(f)))
        ...
        for (a = 0; b && a < e.length; ) {
          ...
          if (!("html" === l || "body" === l)) {
            ...
            for (s = 0; s < b.childNodes.length; s++)
              1 === b.childNodes[s].nodeType &&
                b.childNodes[s].nodeName.toLowerCase() === l &&
                f.push(b.childNodes[s])
            if (!f[n]) return v
            b = f[n]
          }
          a++
    ...
    mt.g.pa = function (a, e) {
      ...
      for (; a.parentNode != v; ) {
        for (
          var f = 0, l = 0, q = a.parentNode.childNodes.length, s = 0;
          s < q;
          s++
        ) {
    ...
    mt.g.getAttribute = function (a, e) {
      ...
      if (!b && a.attributes && a.attributes.length)
        for (var n = a.attributes, f = n.length, l = 0; l < f; l++)
    ...
    mt.g.O = function (g, e) {
      var d
      a.F(g) && 0 === String(g).indexOf("!HMCQ!")
        ? ((d = String(g)),
          (d = b.j(document.location.href, d.substring(6, d.length))))
        : a.F(g) ||
          ((d = mt.g.P(g)),
          "input" === d && e && ("button" === g.type || "submit" === g.type)
            ? (d = a.trim(g.value) || "")
            : "input" === d && !e && "password" !== g.type
            ? (d = a.trim(g.value) || "")
            : "img" === d
            ? ((d = mt.g.getAttribute),
              (d = d(g, "alt") || d(g, "title") || d(g, "src")))
            : (d =
                "body" === d || "html" === d
    ...
    ;(function () {
      ;(mt.g.ec = (function () {
        ...
        ;(function () {
          if (!d)
            if (((d = u), "complete" === document.readyState)) a.ba = u
  ...
  ;(function () {
    var a = mt.lang,
      ...
      g = {
        ...
        Va: function (a, b) {
          return (
            g.Wa(h.c && h.c.b && h.c.b.u, a, b) ||
            g.Wa(document.location.href, a, b)
          )
        },
        Wa: function (a, d, n) {
          if (a === r) return w
          ...
          if (!a.d(n, "Undefined")) {
            ...
            if (a.d(n, "Object")) {
              var f = [],
                l
              for (l in n)
                n.hasOwnProperty(l) && g.Va(l, d) && (f = f.concat(n[l]))
              return f
            }
          }
        },
    ...
    var a = mt.url,
      ...
      d = {
        ...
        setData: function (a, f, l) {
          try {
            b.set(a, f, { domain: d.$(), path: d.ma(), N: l }),
              l ? g.set(a, f, l) : e.set(a, f)
          } catch (q) {}
        },
        removeData: function (a) {
          try {
            b.set(a, "", { domain: d.$(), path: d.ma(), N: -1 }),
              e.remove(a),
              g.remove(a)
          } catch (f) {}
        },
        $: function () {
          for (
            var b = document.location.hostname, e = 0, d = c.dm.length;
            e < d;
            e++
          )
            if (a.wa(b, c.dm[e])) return c.dm[e].replace(/(:\d+)?[/?#].*/, "")
          return b
        },
        ma: function () {
          for (var b = 0, e = c.dm.length; b < e; b++) {
            var d = c.dm[b]
            if (-1 < d.indexOf("/") && a.Ua(document.location.href, d))
              return d.replace(/^[^/]+(\/.*)/, "$1") + "/"
          }
          return "/"
        },
  ...
  ;(function () {
    var a = mt.lang,
      ...
      l = {
        ...
        ra: function () {
          for (var a = {}, b, d = n.length - 1; 0 <= d; d--) {
            b = e[n[d]]
        ...
        n: function (b) {
          b !== r &&
            ("userId" === b && a.d(e.user, "Object")
              ? (delete e.user.uid_, l.Ba())
              : "user" === b && a.d(e.user, "Object")
              ? ((b = e.user.uid_),
                (e.user = b === r ? {} : { uid_: b }),
                l.Ba())
              : e[b] !== r && (e[b] = {}))
        ...
        $b: function (a, b, d) {
          ...
          if (
            ...
            256 < encodeURIComponent(String(d)).length
          )
            m = w
          else {
            var k = f[b]
  ...
  ;(function () {
    ...
    if (b.isArray(c.cptrk) && 0 < c.cptrk.length) {
      var f = {
        ...
        ea: {},
        init: function () {
          for (var a, d = e.Z(c.cptrk) || [], g = 0; g < d.length; g++)
            if (((a = d[g]), a.a !== r && b.d(a.a, "Object"))) {
              a = a.a
        ...
        Ya: function () {
          ...
          for (d in f.ea)
            if (
              f.ea.hasOwnProperty(d) &&
              f.Za[d] === r &&
              ((b = f.ea[d]), (b = a.na(b)))
            )
              (e = e === r ? {} : e), (e[d] = a.O(b, w)), (f.Za[d] = u)
          return e
        },
        ta: function () {
          var a = f.Ya()
        ...
        Xb: function () {
          "MutationObserver" in window && document.body
            ? new MutationObserver(f.ta).observe(document.body, {
                childList: u,
                subtree: u,
              })
      ...
      e = {
        Y: function (a, n) {
          return function (f) {
            ...
            if (l) {
              var q = g.Z(n) || [],
                s = l.getAttribute(a.fa)
              f = f.clientX + ":" + f.clientY
              if (s && s === f) l.removeAttribute(a.fa)
              else if (0 < q.length && (l = b.Jb(l)) && l.length)
                if (
                  ((q = l.length),
                  (s = l[l.length - 1]),
                  1e4 > q * s.split(">").length)
                )
                  for (s = 0; s < q; s++) e.eb(a, l[s])
                else e.eb(a, s)
            }
          }
        },
        eb: function (b, e) {
          for (var f = {}, g = String(e).split(">").length, q = 0; q < g; q++)
            (f[e] = ""), (e = e.substring(0, e.lastIndexOf(">")))
          b && a.d(b, "Object") && b.Ka && b.Ka(f)
        },
        fc: function (a, b) {
          return function (e) {
      ...
      q = {
        ...
        Ab: function (b, d) {
          ...
          m &&
            (c.aet && c.aet.length
              ? ((b.ei_ =
                  a.getAttribute(m, f.id) || a.getAttribute(m, "id") || ""),
                (b.ec_ =
                  a.getAttribute(m, f.W) || a.getAttribute(m, "class") || ""),
                (b.ex_ = a.getAttribute(m, f.V) || a.qa(m)),
                (b.en_ = a.getAttribute(m, f.content) || a.O(m, u)),
                (b.et_ = a.getAttribute(m, f.da) || a.P(m)),
                (b.el_ =
                  a.getAttribute(m, f.link) || a.getAttribute(m, "href") || ""))
              : ((b.ex_ = a.getAttribute(m, f.V) || a.qa(m)),
                (b.en_ = a.getAttribute(m, f.content) || a.O(m, u))))
          return b
        },
      ...
      t = {
        Y: function () {
          return function (e) {
            if (h.c && h.c.R && c.aet && c.aet.length) {
              ...
              if (f) {
                var k = h.c.Ja,
                  p = b.getAttribute(f, d.Ia) != v ? u : w
                if (b.getAttribute(f, d.Ha) == v)
                  if (p) t.ha(t.oa(f, e))
                  else {
                    var g = b.P(f)
                    if (a.D(k, "*") || a.D(k, g)) t.ha(t.oa(f, e))
                    else
                      for (; f.parentNode != v; ) {
                        var p = f.parentNode,
                          g = b.P(p),
        ...
        Db: function (f) {
          ...
          if (
            ...
            (z = A.left),
            (A = A.top),
            a.d(d.getBBox, "Function") &&
              ((g = d.getBBox()), (p = g.width), (g = g.height)),
            "html" === (d.tagName || "").toLowerCase())
          )
            (p = Math.max(p, d.clientWidth)), (g = Math.max(g, d.clientHeight))
          return {
            ya: Math.round(100 * ((k - z) / p)),
            Aa: Math.round(100 * ((f - A) / g)),
            Fa: p,
            sa: g,
            Da: ("a" === (d.tagName || "").toLowerCase() ? d : b.zb(d))
              ? "a"
              : "b",
          }
        },
        ...
        ia: function (a) {
          var b = d.Ma
          a.length > b ||
            (encodeURIComponent(s.join("!") + a).length > b &&
              0 < s.length &&
              (t.o(s.join("!")), (s = [])),
            s.push(a))
        },
  ...
  ;(function () {
    var a = mt.lang,
      ...
      m = {
        ...
        ia: function (a) {
          if (encodeURIComponent(q.join("!") + a).length > e.Ma || 3 < q.length)
            m.o(q.join("!")), (q = [])
          q.push(a)
        },
        o: function (a) {
  ...
  ;(function () {
    ...
    function b() {
      ...
      if ((!f || !q) && l && s) (k = u), (m = +new Date())
      else if (f && q && (!l || !s)) (k = w), (x += +new Date() - m)
      f = l
      q = s
      z = setTimeout(b, 100)
    }
    ...
    function e(a) {
      if (
        ...
        (s = "focus" == a.type || "focusin" == a.type ? u : w), b()
    }
    var d = mt.event,
      n = h.t,
      f = u,
    ...
    ;(function () {
      ...
      "object" == typeof document.onfocusin
        ? (d.e(document, "focusin", e), d.e(document, "focusout", e))
        : (d.e(window, "focus", e), d.e(window, "blur", e))
    })()
    h.la = {
      Ib: function () {
        return +new Date() - t
  ...
  ;(function () {
    function a(a, b, e, f) {
      if (!(a === r || b === r || f === r)) {
        ...
        a = String(a).split("!")
        for (var d, k = w, g = 0; g < a.length; g++)
          if (((d = a[g].split("*")), String(b) === d[0])) {
            d[1] = e
            d[2] = f
            a[g] = d.join("*")
            k = u
    ...
    var g = mt.url,
      ...
      k = {
              ...
              push: function () {
                for (var a = window._hmt, b = 0; b < arguments.length; b++) {
                  ...
                  e.d(p, "Array") &&
                    ...
                    "_setAccount" === p[0] &&
                      1 < p.length &&
                      /^[0-9a-f]{31,32}$/.test(p[1]) &&
                      ((p = p[1]), (a.id = p), (a.cmd[p] = a.cmd[p] || [])))
                }
              },
            }),
        ...
        wb: function () {
          if (0 < k.T.length)
            for (var a = 0, b = k.T.length; a < b; a++) k.Ca(k.T[a])
          k.T = v
        },
        Ca: function (a) {
          var b = a[0]
        ...
        _trackPageview: function (a) {
          1 < a.length &&
            ...
            (h.c.b.vl = n.C()),
            (h.c.b.kb = 0),
            h.c.ua ? ((h.c.b.nv = 0), (h.c.b.st = 4)) : (h.c.ua = u),
            k.va || (h.c.b.su = h.c.b.u || document.location.href),
            (h.c.b.u = f.protocol + "//" + document.location.host + a[1]),
            (h.c.b.p = x(m.s("pageview"))),
            h.c.m(),
            (h.c.b.p = ""),
            (h.c.S = +new Date()),
            m.n("pageview"))
        ...
        _trackMobConv: function (a) {
          if (
            ...
            (k.i |= 32), (h.c.b.et = 93), (h.c.b.ep = a), h.c.m()
        },
        ...
        _clearAutoEventTrackingProperty: function (a) {
          1 < a.length && u === a[1] && m.n("autoEventTracking")
        },
            ...
            if (
              ...
              for (var g = 0, k = a.length; g < k; g++) {
                ...
                if (b.plugins[d] && !b.H[d])
                  (b.H[d] = new b.plugins[d](l)), b.w.shift()
                else break
              }
          }
        },
          ...
          if (1 < a.length) {
            ...
            if (e.D(f.$a, d))
              if (
                ...
                b.H[d] = new b.plugins[d](g)
              else {
                b.w = b.w || []
                for (var g = 0, l = b.w.length; g < l; g++)
                  if (b.w[g][1] === d) return
                b.w.push(a)
  ...
  ;(function () {
    function a() {
      "undefined" === typeof window["_bdhm_loaded_" + c.id] &&
        ...
        (this.Ra = this.Qa = u),
        (this.R = k.R),
        (this.Ja = d.F(c.aet) && 0 < c.aet.length ? c.aet.split(",") : ""),
        (this.ua = w),
        this.init())
    }
    var b = mt.url,
    ...
    a.prototype = {
      ...
      Mb: function () {
        ...
        var a = w
        this.aa(document.referrer) && this.aa(document.location.href)
          ? (a = u)
          : ((a = b.Q(document.referrer)),
            (a = b.wa(a || "", document.location.hostname)))
      ...
      mc: function () {
        ...
        if (
          0 === c.nv &&
          this.aa(document.location.href) &&
          ("" === document.referrer || this.aa(document.referrer))
        )
          (a = 0), (b = 4)
        this.b.nv = a
        this.b.st = b
      ...
      nc: function () {
        ...
        this.b.cw = b.j(a, k.Sb) || b.j(a, k.wc) || ""
            ...
            s.e(window, "message", function (d) {
              if (b.Q(d.origin) === k.rc) {
                ...
                if (RegExp(c.id).test(d.sd || "") && f)
                  (a.b.rnd = Math.round(Math.random() * k.za)),
